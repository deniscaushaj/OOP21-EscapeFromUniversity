...
public class PlayerImpl extends AbstractDynamicGameObject implements Player{
    ...
    private static final Point2D SECONDARY_HIT_BOX_PLAYER = new Point2D(1, 1);
    private int life;
    private int credits;
    private int damage;
    private int armor;
    ...
    public PlayerImpl(GameObjectType type, Point2D position, double speed, Vector2D direction, int shootDelay, Mapp map) {
        this.life = MAX_LIFE;
