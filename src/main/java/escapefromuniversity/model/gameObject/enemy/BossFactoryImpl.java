...
public class BossFactoryImpl implements BossFactory {
     ...
     */
    @Override
    public Boss createBoss1(final Point2D position, final Vector2D direction, final GameInit map) {
     ...
     */
    @Override
    public Boss createBoss2(final Point2D position, final Vector2D direction, final GameInit map) {
     ...
     */
    @Override
    public Boss createBoss3(final Point2D position, final Vector2D direction, final GameInit map) {
     ...
     */
    @Override
    public Boss createBoss4(final Point2D position, final Vector2D direction, final GameInit map) {
     ...
     */
    @Override
    public Boss createBoss5(final Point2D position, final Vector2D direction, final GameInit map) {
     ...
     */
    @Override
    public Boss createBoss6(final Point2D position, final Vector2D direction, final GameInit map) {
